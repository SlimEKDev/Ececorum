...
CandidPathEspp41 <- PathEspp41[PathEspp41$EC.Conservation != 100 & PathEspp41$EC.Conservation >= PathEspp41mEceco$EC.Conservation , ]
...
write.csv(PathECAmelio, file = "Pathw-Candid_Cribl-Amelio-EC2.csv")
